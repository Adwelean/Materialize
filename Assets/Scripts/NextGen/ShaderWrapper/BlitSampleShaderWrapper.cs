...
{
    public class BlitSampleShaderWrapper : ShaderWrapperBase
    {
        ...
        public float Sample1Height { get => GetMaterialProperty<float>(); set => SetMaterialProperty(value: value); }
        ...
        public float Sample2Height { get => GetMaterialProperty<float>(); set => SetMaterialProperty(value: value); }
        ...
        public float Sample3Height { get => GetMaterialProperty<float>(); set => SetMaterialProperty(value: value); }
        public float SampleBlend { get => GetMaterialProperty<float>(); set => SetMaterialProperty(value: value); }
        ...
        private protected override Material CreateMaterial() => new Material(Shader.Find("Hidden/Blit_Sample"));
    }
}